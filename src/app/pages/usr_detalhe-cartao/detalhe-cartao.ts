	...
	import { RecargaCelularPage } from '../usr_recarga-celular/recarga-celular';
	...
	export class DetalheCartaoPage {
		...
		goToChangePhone(passType){
			let id_user = 0;
			let pageTitle = '';
			
				id_user = this.card['r_id_usuario_cartao'];
				pageTitle = 'Recarga Celular';		

			//this.vibration.vibrate(50);
			this.navCtrl.push(RecargaCelularPage, {
				title: pageTitle,
				empresa: this.card['r_empresa'],
				tipo_senha: passType,
				id_user: id_user,
				cardNumber: this.card['r_numero_cartao'],
				cardSenha: this.card['r_senha_cartao'],
				cardNome: this.card['r_nome_cartao']
